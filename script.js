            ...
            <div class="row justify-content-center">
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  ...
                  <span><i class="fa-brands fa-whatsapp"></i> +919306246680</span>
                </div>
              </div>
            </div>
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <a href="https://www.instagram.com/himnishmehndiratta_/" target="_blank" class="text-warning">Himnish Mehandiratta</a> © 2022 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
